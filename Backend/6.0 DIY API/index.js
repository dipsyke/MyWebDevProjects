...
app.get("/random/", async (req, res) => {
    try {
        const joke = jokes[Math.floor(Math.random(jokes) * jokes.length)];
...
app.get("/filter", async (req, res) => {
    try {
        console.log('hap/filter')
        console.log(req.query)
        const type = req.query.type;
        let filteredJokes = jokes.filter((joke)=> joke.jokeType===type);
...
app.post("/jokes", async (req,res) => {
    try{
        ...
        // const newJokeTpe = req.body.type
